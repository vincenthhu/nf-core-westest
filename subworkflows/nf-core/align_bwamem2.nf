...
workflow ALIGN_BWAMEM2 {
    ...
    main:
        ...
        .map{ meta, bam ->
            ...
            new_meta.id = new_meta.id.split(',')[0] // access the .id attribute of meta to split samplename_lane into samplename
        ...
        SAMTOOLS_MERGE ( bams.multiple, [] )    // NOTE: after groupTuple, bam.multiple contains a list of
